...
# Config
auth_url = "https://hdfauth.ftven.fr/esi/TA?format=json&url=https://simulcast-p.ftven.fr/simulcast/France_5/hls_fr5/index.m3u8"
m3u8_path = Path("a02/fr5.m3u8")
bak_path = Path("a02/bak/fr5.bak")
TIMEOUT = 10
