...
# Config
auth_url = "https://hdfauth.ftven.fr/esi/TA?url=https://live-thema.ftven.fr/hls-francedomtom/index.m3u8"
m3u8_path = Path("a02/frdocs.m3u8")
bak_path = Path("a02/bak/frdocs.bak")
TIMEOUT = 10
