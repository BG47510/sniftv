...
# Config
auth_url = "https://hdfauth.ftven.fr/esi/TA?url=https://simulcast-frmedias-p.ftven.fr/simulcast/LCP_PS/hls_lcp_ps/index.m3u8"
m3u8_path = Path("a02/frlcp.m3u8")
bak_path = Path("a02/bak/frlcp.bak")
TIMEOUT = 10
