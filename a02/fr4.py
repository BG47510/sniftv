...
# Config
auth_url = "https://hdfauth.ftven.fr/esi/TA?format=json&url=https://simulcast-p.ftven.fr/simulcast/France_4/hls_fr4/index.m3u8"
m3u8_path = Path("a02/fr4.m3u8")
bak_path = Path("a02/bak/fr4.bak")
TIMEOUT = 10
